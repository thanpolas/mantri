...
exports.commands = function() {
  ...
  exports.table([
    ...
    ['deps', 'The deps task generates the dependency file "deps.js".' +
      ' This file is required by the web application so it can operate' +
      ' in the development environment.'],
    ['build', 'The mantriBuild task bundles and minifies all your' +
