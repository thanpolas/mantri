...
valid.validate = function( buildOpts ) {
  ...
  // TODO even more FUGLY, extending an object passed as argument
  ...
  buildOpts._noCompile = buildOpts._noCompile || mantriConf._noCompile || false;
  buildOpts.buildModules = mantriConf.buildModules || [];
  buildOpts.sourceMapFile = buildOpts.sourceMapFile ||
    mantriConf.build.sourceMapFile || false;
  buildOpts.sourceMappingURL = buildOpts.sourceMappingURL ||
    mantriConf.build.sourceMappingURL || false;
  buildOpts.closureLibrary = mantriConf.closureLibrary || null;
...
valid.mantriConfValidate = function(mantriConf, buildOpts, confFile) {
  ...
  if (__.isObject(mantriConf.buildModules)) {
    try {
      __.forIn(mantriConf.buildModules, valid._validateModule);
    } catch(ex) {
      return false;
    }
  } else {
