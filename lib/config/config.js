 ...
 */
Deppy.Config.CONFIG_FILE = 'deppyConf';
...
Deppy.Config.prototype.fetch = function() {
  ...
  var elementDepFile = goog.dom.dataset.get(el,
    Deppy.Config.CONFIG_DATA_KEY);

  var configPath = elementDepFile || Deppy.Config.CONFIG_FILE;

  this._loader.writeScript(configPath + Deppy.ModuleLoader.JS_EXT);
  this._loader.writeScript('deppy.configFinished();', true);
};
